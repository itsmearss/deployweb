    ...
    <div class="col-lg-8">
        <form action="/user/dashboard/houses" method="POST" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control rounded-1 @error('harga') is-invalid @enderror" id="harga" name="harga" required autofocus value="{{ old('harga') }}" placeholder="Masukkan Harga (dalam juta)">
              @error('harga')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
            ...
            <div class="row mb-3">
              <div class="col-lg-3">
                ...
                <input type="number" class="form-control rounded-1 @error('luas_bangunan') is-invalid @enderror" id="luas_bangunan" name="luas_bangunan" required autofocus value="{{ old('luas_bangunan') }}" placeholder="Luas Bangunan">
                @error('luas_bangunan')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-lg-3 mb-3">
                ...
                <input type="number" class="form-control rounded-1 @error('luas_tanah') is-invalid @enderror" id="luas_tanah" name="luas_tanah" required autofocus value="{{ old('luas_tanah') }}" placeholder="Luas Tanah">
                @error('luas_tanah')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
              ...
              <div class="col-lg-3">
                ...
                <input type="text" class="form-control rounded-1 @error('interior') is-invalid @enderror" id="interior" name="interior" required autofocus value="{{ old('interior') }}" placeholder="Jenis Interior">
                @error('interior')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>

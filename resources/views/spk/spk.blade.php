...
@section('container')
    <section id="premium">
        <div class="container-fluid py-5 mt-3 px-5">
            ...
            <p class="text-center">SPK (Sistem Pendukung Keputusan) untuk pemilihan rumah adalah sistem yang membantu Anda menentukan rumah terbaik berdasarkan kriteria. Silahkan baca petunjuknya dibagian bawah.</p>
           ...
           <div class="table-responsive">
            ...
            <div class="d-flex justify-content-between">
                <div class="mt-5">
                    ...
                    <p>Pada SPK dengan metode SAW, terdapat beberapa tahap. <br> Pada tahap ini pilihlah alternatif yang akan anda lakukan pemilihan. <br> Alternatif merupakan daftar rumah yang akan dilakukan perhitungan SPK. <br> Anda bisa memilih alternatif dari data rumah yang ada di website ini dengan klik button <b>ADD</b>. <br> Jika sudah, klik button <b>LAKUKAN SAW</b></p>
                </div>
                <div class="mt-5">

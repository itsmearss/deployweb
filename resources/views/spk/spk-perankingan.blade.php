    ...
    <section id="premium">
        <div class="container-fluid py-5 mt-3 px-5">
            ...
            <div class="mt-5">
                ...
                <p>Perankingan akan menampilkan urutan rumah terbaik dari daftar rumah yang sudah anda pilih<br> Klik button Ikon Mata untuk melihat detail rumah tersebut.</p>
            </div>
        </div>
    </section>
@endsection

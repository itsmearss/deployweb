    ...
    <section id="premium">
        <div class="container-fluid py-5 mt-3 px-5">
            ...
            <div class="mt-5">
                ...
                <p>Pada tahap ini anda akan menentukan nilai dari setiap kriteria <br> Kriteria merupakan nilai yang akan menentukan bobot setiap nilai pada alternatif <br> Tentukanlah nilai bobot dari setiap kriteria, tetapi jumlah bobot harus = 1. <br> Jika sudah, klik button <b>NORMALISASI</b></p>
            </div>
        </div>
    </section>
@endsection

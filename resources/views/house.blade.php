        ...
        <div class="container-fluid mb-4">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    @else
                    <img src="https://res.cloudinary.com/dohsfgda5/image/upload/v1719331125/arsproperty/tamwobwuxewcfkzryudz.png" class="mt-3 mb-3" alt="">
                    @endif
                </div>
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            @else
                            <img src="https://res.cloudinary.com/dohsfgda5/image/upload/v1719331163/arsproperty/ozwu4qgzjpsx2np35f4u.png" class="mt-3 mb-3" alt="">
                            @endif
                        </div>
                        <div class="col-lg-6">
                            @if ($house->image2)

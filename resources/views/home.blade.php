...
@section('container')
    ...
    {{-- Best Listings --}}
    <section id="premium" class="pt-5 mt-5" style="margin-top: 200px">
            ...
            <div class="row mt-5">
                ...
                <div class="col-sm-3">
                    <div class="card mb-3" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        @else
                        <img src="https://res.cloudinary.com/dohsfgda5/image/upload/v1719329120/arsproperty/smfvszjlvfn5srzmawtv.jpg" class="card-img-top" alt="..." width="100%" height="230px">
                        @endif
                        <div class="card-body">
            ...
            <div class="row mt-5">
                ...
                <div class="col-sm-3">
                    <div class="card mb-3" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <img src="https://res.cloudinary.com/dohsfgda5/image/upload/v1719329120/arsproperty/smfvszjlvfn5srzmawtv.jpg" class="card-img-top" alt="{{ $post->category->name }}">
                        <div class="card-body">
